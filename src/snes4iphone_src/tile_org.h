...
#define RENDER_CLIPPED_TILE(NORMAL, FLIPPED, N) \
	...
	{ \
	    /*if ((dd = (*(uint32 *) bp) & d1))*/ \
        dd = (((((uint32)bp[3])<<24)|(((uint32)bp[2])<<16)|(((uint32)bp[1])<<8)|((uint32)bp[0]))&d1); \
        if (dd) NORMAL (Offset, (uint8 *) &dd); \
	    /*if ((dd = (*(uint32 *) (bp + 4)) & d2))*/ \
        dd = (((((uint32)bp[7])<<24)|(((uint32)bp[6])<<16)|(((uint32)bp[5])<<8)|((uint32)bp[4]))&d2); \
        if (dd) NORMAL (Offset + N, (uint8 *) &dd); \
	} \
    } \
    else \
    if (!(Tile & V_FLIP)) \
	...
	{ \
        ...
        dd = (((((uint32)bp[7])<<24)|(((uint32)bp[6])<<16)|(((uint32)bp[5])<<8)|((uint32)bp[4]))&d1); \
        if (dd) FLIPPED (Offset, (uint8 *) &dd); \
	    /*if ((dd = *(uint32 *) bp & d2))*/ \
        dd = (((((uint32)bp[3])<<24)|(((uint32)bp[2])<<16)|(((uint32)bp[1])<<8)|((uint32)bp[0]))&d2); \
        if (dd) FLIPPED (Offset + N, (uint8 *) &dd); \
	} \
    } \
    else \
    if (Tile & H_FLIP) \
...
#define RENDER_CLIPPED_TILEHI(NORMAL, FLIPPED, N) \
	...
	{ \
	    /*if ((dd = (*(uint32 *) bp) & d1))*/ \
        dd = (((((uint32)bp[6])<<24)|(((uint32)bp[4])<<16)|(((uint32)bp[2])<<8)|((uint32)bp[0]))&d1); \
        if (dd) NORMAL (Offset, (uint8 *) &dd); \
	} \
    } \
    else \
