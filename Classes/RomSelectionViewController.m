...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath 
{
	...
	cell.accessoryType = ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) ? UITableViewCellAccessoryDetailDisclosureButton : UITableViewCellAccessoryNone;
...
{
    SaveStateSelectionViewController *viewController = [[SaveStateSelectionViewController alloc] initWithNibName:@"SaveStateSelectionViewController" bundle:nil];
    
    viewController.romFilter = [[objectsForCharacters objectForKey:[arrayOfCharacters objectAtIndex:indexPath.section]] objectAtIndex:indexPath.row];
    [viewController setTitle:@"Saved States"];
    
    UIBarButtonItem *flexibleSpace = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:nil action:nil];
    UIBarButtonItem *controllerButton = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"Controller"] style:UIBarButtonItemStylePlain target:self action:@selector(loadSNESController)];
    UIBarButtonItem *settingsButton = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"settings"] style:UIBarButtonItemStylePlain target:AppDelegate().settingsViewController action:@selector(showSettings)];
    viewController.toolbarItems = [NSArray arrayWithObjects:controllerButton, flexibleSpace, settingsButton, nil];
